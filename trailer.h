...
enum trailer_type {
	...
	/*
	 * This is a line that could not be parsed as a trailer. Examples:
	 *
	 *   - ""        (empty line)
	 ...
	 *
	 * FIXME: This comment will only be fully correct after we replace all
	 * instances of find_separator with parse_trailer().
	 *
	 * NOTE: The separator is hardcoded to be ":". But it can be overridden
	 * with configuration. This means that the "Signed-off-by: "
	 * Git-generated line could technically be parsed as TRAILER_JUNK if the
	 * separator is configured to be something other than ":"; however
	 * Git-generated lines get special treatment to always qualify as if
	 * they were parsed as TRAILER_OK during the initial phase of
	 * identifying the trailer block region.
	 */
	TRAILER_OK,
};
